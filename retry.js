...
function init(){
    ...
    meshFloor = new THREE.Mesh(
        ...
        new THREE.PlaneGeometry(30,30, 10,10), //plane이니까2차원-앞parameter2개가size결정
    ...
    light = new THREE.PointLight(0xff4444, 0.4, 50);
    ...
    light2 = new THREE.PointLight(0x4444ff, 0.4, 50);
    light2.position.set(5,10,5);
    light2.castShadow = true;
    light2.shadow.camera.near = 0.5;
    light2.shadow.camera.far = 11;
    scene.add(light2);
...
function animate(){
    ...
    if(camera.position.x > 3 && camera.position.x < 7){
        if(camera.position.z > 3 && camera.position.z < 7){
